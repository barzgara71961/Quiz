...
class Quiz:
    ...
    def division(self):
        ...
        Division(self, starting_question, low_amount, high_amount)
...
class Addition:
    def __init__(self, partner, starting_question, low_amount, high_amount):
        ...
        for item in range(1, starting_question):
            hi_lo_num = random.randrange(low_amount, high_amount)
    ...
    def check_ans(self):
        ...
        hi_lo_num = random.randrange(1, 10)
        hi_lo_num2 = random.randrange(1, 10)
        questions = "{} + {}".format(hi_lo_num, hi_lo_num2)
        ...
        self.check_ans_btn = Button(self.ask_questions_frame, text="Next", font="arial 10 bold", fg="black",
                                    bg="#95E06C", pady=7,
                                    command=lambda: self.next(correct,low_amount, high_amount))
        self.check_ans_btn.grid(row=2, column=1)
